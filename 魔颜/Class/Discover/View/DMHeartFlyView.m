...
-(void)animateInView:(UIView *)view{
    NSTimeInterval totalAnimationDuration = 2;
    ...
    //Bloom
    [UIView animateWithDuration:0.1 delay:0.0 usingSpringWithDamping:0.6 initialSpringVelocity:0.4 options:UIViewAnimationOptionCurveEaseOut animations:^{
    ...
    //random end point
    CGPoint endPoint = CGPointMake(heartCenterX + (rotationDirection) * arc4random_uniform(2*heartSize), viewHeight/3 + arc4random_uniform(viewHeight/3));
