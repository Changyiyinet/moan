...
@interface MYIdeaViewController ()<UITableViewDataSource,UITableViewDelegate>
...
-(void)addtableview
{
    UITableView *tableview = [[UITableView alloc]initWithFrame:CGRectMake(0, 60, MYScreenW, MYScreenH-40-64)];
