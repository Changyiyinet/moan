...
- (void)setupScrollView
{
    ...
    UILabel *titleLabel = [UILabel addLabelWithFrame:CGRectMake(picView.right + kMargin, picView.y - 6, width, 50) title:self.goodsTitle titleColor:UIColorFromRGB(0x333333) font:MYFont(14)];
    ...
    //特惠价
    UILabel *disPriceLabel = [UILabel addLabelWithFrame:CGRectMake(MYScreenW  - 100, titleLabel.y - 8, 100-15, titleLabel.height) title:[NSString stringWithFormat:@"￥%@",self.discountPrice] titleColor:UIColorFromRGB(0xed0381) font:MYFont(14)];
    disPriceLabel.textAlignment = NSTextAlignmentRight;
    [goodsView addSubview:disPriceLabel];
    
    //原价
    UILabel *priceLabel = [UILabel addLabelWithFrame:CGRectMake(disPriceLabel.x, disPriceLabel.bottom, 100-15, disPriceLabel.height) title:[NSString stringWithFormat:@"￥%@",self.price] titleColor:UIColorFromRGB(0x808080) font:MYFont(10)];
