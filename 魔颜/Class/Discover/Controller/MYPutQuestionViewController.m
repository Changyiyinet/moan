...
{
    UIView *tableheader = [[UIView alloc]initWithFrame:CGRectMake(0, 0, MYScreenW, MYScreenW / 2.5 + 10)];
    self.tableview.tableHeaderView = tableheader;
    
    UIButton *btn = [UIButton addButtonWithFrame:CGRectMake(0, 10, MYScreenW, MYScreenW / 2.5) backgroundColor:nil Target:self action:@selector(clickBtn)];
