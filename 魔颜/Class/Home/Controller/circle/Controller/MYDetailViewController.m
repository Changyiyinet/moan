...
-(void)setupBoomView
{
    ...
    //点赞按钮
    UIButton *praiseBtn = [UIButton addButtonWithFrame:CGRectMake(MYScreenW - 35, kMargin, 31, 31) backgroundColor:nil Target:self action:@selector(ClickDianzanBtn)];
    ...
    praiseBtn.adjustsImageWhenHighlighted = NO;
    praiseBtn.adjustsImageWhenDisabled = NO;
